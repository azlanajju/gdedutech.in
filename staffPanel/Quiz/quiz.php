...
// Add staff_id filter to only show quizzes created by this staff member
...
// Fetch total number of quizzes for this staff member
$total_quizzes_query = mysqli_query($conn, "SELECT COUNT(*) as count FROM Quizzes q 
...
// Fetch quizzes with course information and question count for this staff member
$query = "SELECT 
            q.*, 
...
mysqli_stmt_bind_param($stmt, 'iii', $staff_id, $limit, $offset);
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-4">
                        <div class="col">
                            ...
                            <p class="text-muted">Welcome, <?php echo htmlspecialchars($staff_name); ?></p>
                        </div>
                        <div class="col-auto">
