...
<head>
    ...
    <style>
        ...
        .stats-card:nth-child(1), .stats-card:nth-child(1) h3 {
            border-color: #0d7298;
            color: #0d7298;
        }
        .stats-card:nth-child(2), .stats-card:nth-child(2) h3 {
            border-color: #0d7298;
            color: #1565C0;
        }
        .stats-card:nth-child(3), .stats-card:nth-child(3) h3 {
            border-color: #0d7298;
            color: #EF6C00;
        }
        .stats-card:nth-child(4), .stats-card:nth-child(4) h3 {
            border-color: #0d7298;
            color: #6A1B9A;
        }
        .stats-card h3 {
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <img src="../../../uploads/profile_images/<?php echo $user['profile_image'] ?: '../../assets/images/default-avatar.png'; ?>" 
                                         alt="Profile" 
